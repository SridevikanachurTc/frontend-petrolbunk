...
import ManangerGraphApi from '../services/ManagerGraphApi';
import AsyncStorage from '@react-native-async-storage/async-storage';

function ManagerLineGraph() {
  // const data = {
  //   labels: ["16", "17", "18"],
  //   datasets: [
  //     {
  ...
  useEffect(() => {
    const fetchTotalReductionPerHour = async () => {
      try {
        ...
        const salesData = await ManangerGraphApi.getTotalReductionPerHour(
          bunkId,
        );
...
//       try {
//         const bunkId = await AsyncStorage.getItem('bunkId');
//         const salesData = await ManangerGraphApi.getTotalReductionPerHour(bunkId);
...
//         const reductionData = formattedData.map((item) => item.reduction);
